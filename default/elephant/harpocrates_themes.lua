--
-- Dynamic Harpocrates Theme Menu for Elephant/Walker
--
Name = "harpocratesthemes"
NamePretty = "Harpocrates Themes"

-- The main function elephant will call
function GetEntries()
  local entries = {}
  local theme_dir = os.getenv("HOME") .. "/.config/harpocrates/themes"
    ...
    if theme_name then
      ...
      if preview_path and preview_path ~= "" then
        ...
        table.insert(entries, {
          ...
          PreviewType = "file",
          Actions = {
            activate = "harpocrates-theme-set " .. theme_name,
          },
        })
      end
    end
